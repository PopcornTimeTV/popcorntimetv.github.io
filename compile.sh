...
cd $PROJECT_DIR
xcodebuild -workspace "PopcornTime.xcworkspace" -scheme "PopcornTimeiOS" -sdk "iphoneos11.4" -configuration Release CODE_SIGN_IDENTITY="-" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO" archive -archivePath $CURRENT_DIR/PopcornTime.xcarchive
